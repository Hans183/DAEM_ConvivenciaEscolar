...
export const generateDecPDF = (record: DecRecord) => {
  ...
  addTwoFields(
    ...
    "Edad",
    record.edad_estudiante ? `${record.edad_estudiante} años` : null,
  );
  ...
  addField(
    ...
    record.otra_antecedentes || record.ConflictoConEstudiante_antecedentes || record.ConflictoConProfesor_antecedentes,
  );
