  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{protocolo ? "Editar Protocolo" : "Agregar Protocolo"}</DialogTitle>
          <DialogDescription>
            {protocolo ? "Actualiza los datos del protocolo." : "Crea un nuevo protocolo rellenando este formulario."}
          </DialogDescription>
        </DialogHeader>
                                ...
                                {establecimientos.map((est) => (
                                  ...
                                  >
                                    <Check
                                      className={cn(
                                        "mr-2 h-4 w-4",
                                        field.value === est.id ? "opacity-100" : "opacity-0",
                                      )}
                                    />
                                    {est.nombre}
                                  </CommandItem>
